    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-white">MESCE</span> <span class="clr-white">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
var bestDishes = [
    ...
    },
    {
        title: 'Fried chicken',
        rating: 4,
        imgURL: "assets/images/chickenfry.jpg",
        description: "Sumptuous delicious food baked in our cafe with curated ingredients",
        price: 30
    },
    {
        title: 'Biriyani',
        rating: 5,
        imgURL: "assets/images/biryani.jpg",
        description: "Sumptuous delicious food baked in our cafe with curated ingredients",
        price: 80
    },
    {
        title: 'Porotta',
        rating: 5,
        imgURL: "assets/images/porotta.jpg",
        description: "Sumptuous delicious food baked in our cafe with curated ingredients",
        price: 10
    },
    {
        title: 'Cream bun',
        rating: 4,
        imgURL: "assets/images/cream bun.jpg",
        description: "Sumptuous delicious food baked in our cafe with curated ingredients",
        price: 25
    }
]
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-white md">MESCE</span> <span class="clr-white md">Canteen</span></div>
        ...
        <div class="modal-content m-content-2 py-1">
            ...
            style="cursor: pointer;">
                <span class="clr-white">Log In</span>
            </a>
        </div>
    </div>
`;
    ...
    <div class="modal-container">
        ...
        <div class="modal-content m-content-2 py-1">
            ...
            <a id="signup-modal" 
                ...
                style="cursor: pointer;">
                <span class="clr-white">Create one</span>
            </a>
        </div>
    </div>
`;
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>MESCE College Of Engineering established in 1994,
                        Kerala's first self-financing Engineering College is a beacon of technical education.
                        Accredited by AICTE and CoA, it offers diverse undergraduate and postgraduate programs,
                        including B Arch and M Tech. Affiliated to APJ Abdul Kalam
                        Technological University and University of Calicut,
                        it houses NBA-accredited programs and boasts ISO certification.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://m.facebook.com/profile.php?id=109258819092953" target="_blank"> Facebook</a></li>
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://www.mesce.ac.in/" target="_blank">MESCE kuttippuram</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91 94000 62101</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>mail@mesce.ac.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Kumbidi-Thrikkanapuram Rd, Kuttippuram, Tavanur, Kerala 679582</p></li>
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://mesce.ac.in/" target="_blank">MESCE kuttipuram</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
